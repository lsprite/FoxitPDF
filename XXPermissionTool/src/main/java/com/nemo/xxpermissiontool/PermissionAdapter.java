...
public class PermissionAdapter extends BaseAdapter {
    private List<XXPermissionBean> mData;
    private int mTextColor;
    private int mFilterColor;

    public PermissionAdapter(List<XXPermissionBean> data) {
        mData = data;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        XXPermissionBean item = mData.get(position);
        ...
        icon.setImageResource(item.getDrawId());
